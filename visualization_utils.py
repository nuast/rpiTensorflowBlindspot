...
def draw_bounding_box_on_image_array(image,
  ...
  # Let's save the results (bodge 100 to fit time constraints)
  p = open('/home/pi/tensorflow1/models/research/object_detection/objDet.txt','a+') # Open file and append - we need to clear file each loop in ObjDe*.py
  p.write(display_str_list[0])
  p.close()
  with open('/home/pi/tensorflow1/models/research/object_detection/objDect.txt','a+') as history_text_file:
    history_text_file.write(str(display_str_list[0])+'\n')
  print(display_str_list[0])
  return display_str_list[0]
